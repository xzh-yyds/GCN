...
class Cluster_Kmean(object):
    ...
    def __init__(self, K, n_init=10, max_iter=250, batch_size=256) -> None:
        super().__init__()
        self.K = K
        self.n_init = n_init
    ...
    def cluster(self, embed):
        ...
        clustering = MiniBatchKMeans(n_cluster=self.K, n_init=self.n_init, max_iter=self.max_iter, batch_size=self.batch_size)
