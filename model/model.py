...
class GCNAE(nn.Module):
    def __init__(self, input_feat_dim, hidden_dim1, hidden_dim2, dropout):
        ...
        # encode layer
        self.encgc1 = GraphConvolution(input_feat_dim, hidden_dim1, dropout, act=F.relu)    # relu1
        self.encgc2 = GraphConvolution(hidden_dim1, hidden_dim2, dropout, act=lambda x: x)

        # decode layer
        self.decgc1 = GraphConvolution(hidden_dim2, hidden_dim1, dropout, act=F.relu)       # relu2
    ...
    #  计算，先通过编码器将X变成Z，然后在通过解码器将Z变成hat{X}
